...
syn keyword sqlType  varchar with zone
...
syn keyword gisLineString ST_Length ST_StartPoint ST_EndPoint ST_NPoints
...
if version >= 508 || !exists("did_sql_syn_inits")
  ...
  HiLink gisLineString Function
  HiLink gisPolygon Function
  HiLink gisCollection Function
...
let b:current_syntax = "postgresql"
